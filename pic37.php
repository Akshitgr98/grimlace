		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				...
				<br><p class="text-center"><strong>Nike Huarache <br>(Jet Black)</strong></p>
			 </div>
			 <div class="col-sm-7 col_6">
					<h4><b>Description</b></h5>
					<p>youth lifestyle sneakers from Nike brand <br><br>
...
<br>* huarache</p>
				...
				<p class="movie_option"><strong>MRP: ₹ </strong><strike style="color:red">15,000</strike></p>
