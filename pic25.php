		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				...
				<br><p class="text-center"><strong>Adidas StanSmith Velcro(Gray)</strong></p>
			 </div>
 ...
 <br>• Synthetic leather lining; Jersey sockliner</p>
	    	...
	    	<h4 class="tag_head">Similar Products</h4>
	         <ul class="tags_images">
				...
				<li class="last"><a href="pic20.php"><img src="images/pic20.gif" class="img-responsive" alt=""/></a></li>
				<div class="clearfix"> </div>
			 </ul>
			</div>
	    </div>
