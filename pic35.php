		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				...
				<br><p class="text-center"><strong>Nike Hypervenom Football Studs</strong></p>
			 </div>
			 <div class="col-sm-7 col_6">
					<h4><b>Description</b></h5>
					<p>Nike Men's Hypervenom Phantom II NJR FG Soccer Cleat Upper features a Dynamic fit collar and Flywire to lock your heel and forefoot down NikeSkin upper with ACC technology enhances touch to give you complete control over the ball in wet and dry conditions Molded sockliner cushions your foot to reduce stud pressure Nylon chassis with a Pebax base and a split-toe plate is designed to give you responsive agility, making you quicker than your opponent Studs have TPU tips for long-lasting durability and traction on firm, natural surfaces 
					<br><br><b>Features & details</b><br>
<br>* Synthetic
<br>* Synthetic sole
<br>* Upper features a Dynamic fit collar and Flywire to lock your heel and forefoot down
<br>* NikeSkin upper with ACC technology enhances touch to give you complete control over the ball in wet and dry conditions
<br>* Molded sockliner cushions your foot to reduce stud pressure</p>
				<form method="post"><input type="submit" class="btn_3" value="order" name="order"></form>
				<p class="movie_option"><strong>Our Price: ₹ </strong>6,000</p>
			</div>
			<div class="clearfix"> </div>
		  </div>
