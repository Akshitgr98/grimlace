		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				...
				<br><p class="text-center"><strong>Nike Airmax-2017 (Green)</strong></p>
			 </div>
			 <div class="col-sm-7 col_6">
					<h4><b>Description</b></h5><br>
					<p>
Lightweight mesh and maximum support fromt our best airbed to date, the air max 2017 is an amazingly light and comfortable powerhouse
       synthetic-and-mesh.<br/><br><b>Features & Details</b><br><br>
* Flywire cables integrate with the laces and wrap your arch for an adaptive, supportive fit.<br>
* Plush foam and mesh tongue for breathable comfort<br>
* Midsole flex grooves provide greater forefoot flexibility<br>
* Waffle outsole for durability and great multi-surface traction</p>
				<form method="post"><input type="submit" class="btn_3" value="order" name="order"></form>
				<p class="movie_option"><strong>Our Price: ₹ </strong>4,099</p>
			</div>
			<div class="clearfix"> </div>
		  </div>
	    	...
	    	<h4 class="tag_head">Similar Products</h4>
	         <ul class="tags_images">
				...
				<li><a href="pic53.php"><img src="images/pic53.jpg" class="img-responsive" alt=""/></a></li>
				<li class="last"><a href="pic50.php"><img src="images/pic50.jpg" class="img-responsive" alt=""/></a></li>
				<div class="clearfix"> </div>
			 </ul>
			</div>
	    </div>
