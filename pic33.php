		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				...
				<br><p class="text-center"><strong>Nike Superfly Football Studs (Black pink)</strong></p>
			 </div>
...
<br>* Updated stud configuration was developed using computer modeling to achieve the ideal balance of traction, torque and comfort.</p>
				<form method="post"><input type="submit" class="btn_3" value="order" name="order"></form>
				<p class="movie_option"><strong>Our Price: ₹ </strong>5,299</p>
			</div>
			<div class="clearfix"> </div>
		  </div>
