		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				...
				<br><p class="text-center"><strong>Adidas SpringBlade(Yellow)</strong></p>
			 </div>
			 <div class="col-sm-7 col_6">
					<p><b>Features & details</b>
 <br><br>• Material Type: Mesh
 <br>• Lifestyle: Casual 
<br>• Closure Type: Lace-Up
 <br>• Care Instructions: Allow your pair of shoes to air and de-odorize at regular basis; use shoe bags to prevent any stains or mildew; dust any dry dirt from the surface using a clean cloth; do not use polish or shiner</p>
				<br>
				<p class="movie_option"><strong>MRP: ₹ </strong><strike style="color:red">11,200</strike></p>
	    	...
	    	<h4 class="tag_head">Similar Products</h4>
	         <ul class="tags_images">
				...
				<li><a href="pic24.php"><img src="images/pic24.jpg" class="img-responsive" alt=""/></a></li>
