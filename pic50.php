		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				...
				<br><p class="text-center"><strong>Nike Tavas Airmax (Grey Mist- Flash Lime)</strong></p>
			 </div>
 ...
 <br>• Air Max Tavas</p>
	    	...
	    	<h4 class="tag_head">Similar Products</h4>
	         <ul class="tags_images">
				...
				<li><a href="pic49.php"><img src="images/pic49.jpg" class="img-responsive" alt=""/></a></li>
