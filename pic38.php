		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				...
				<br><p class="text-center"><strong>Nike Huarache <br>(White)</strong></p>
			 </div>
...
<br>* huarache</p>
				...
				<p class="movie_option"><strong>MRP: ₹ </strong><strike style="color:red">20,000</strike></p>
				<p class="movie_option"><strong>Our Price: ₹ </strong>4,000</p>
			</div>
			<div class="clearfix"> </div>
		  </div>
