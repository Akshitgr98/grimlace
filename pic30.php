		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				...
				<br><p class="text-center"><strong>Adidas Gazelle</strong></p>
			 </div>
			 <div class="col-sm-7 col_6">
					<h4><b>Description</b></h5><br>
					<p>A pair of navy sneakers, has central lace-ups
Suede upper, has Adidas patented tri-stripes on either side of the midfoot and a reinforced heel collar
Cushioned footbed, has Ortholite technology for enhanced cushioning  and to prevent odour
