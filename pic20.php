		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				<img src="images/pic20.gif" class="img-responsive" alt=""/>
				<br><p class="text-center"><strong>Adidas Radium Superstar Xeno</strong></p>
			 </div>
...
<br>* Warranty Type: Manufacturer<br><br><b>(Special Edition)</b></p>
				<br>
