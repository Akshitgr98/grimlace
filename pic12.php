		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				...
				<br><p class="text-center"><strong>Adidas Superstar (Splash)</strong></p>
			 </div>
...
<p class="movie_option"><strong>MRP: ₹ </strong><strike style="color:red">11,000</strike></p>
	    	...
	    	<h4 class="tag_head">Similar Products</h4>
	         <ul class="tags_images">
				...
				<li><a href="pic8.php"><img src="images/pic8.jpg" class="img-responsive" alt=""/></a></li>
				<li class="last"><a href="pic13.php"><img src="images/pic13.jpg" class="img-responsive" alt=""/></a></li>
				<div class="clearfix"> </div>
			 </ul>
			</div>
	    </div>
