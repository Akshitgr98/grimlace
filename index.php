...
?>
	<div class="header">	
	 ...
	 <div class="rows" style="padding-bottom:250px;padding-top:250px;background:url('images/123.jpg')">
	 <div class="col-md-2"></div>
	 <div class="col-md-8 text-center" style="width:100%;font-size:10vw;color:white;background:url(images/rnb.jpg);border-radius:16%">Welcome To The Quinn Folks!</div>
	 <div class="col-md-2"></div>
	 <div class="clearfix"></div>
	 </div>
	<div class="grid_3"style="margin-botto,:0px">
