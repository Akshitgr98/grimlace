		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				<img src="images/pic55.jpeg" class="img-responsive" alt=""/>
				<br><p class="text-center"><strong>Adidas Alphabounce (Black)</strong></p>
			 </div>
			 <div class="col-sm-7 col_6">
					<h4><b>Features & Details</b></h5><br>
					<p>
Material Type: Mesh
<br>Lifestyle: Casual
<br>Closure Type: Lace-Up</p>
 <br>
				<p class="movie_option"><strong>MRP: ₹ </strong><strike style="color:red">10,000</strike></p>
