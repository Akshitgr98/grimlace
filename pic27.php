		...
		<div class="container">
		   <div class="single_box1">
			 <div class="col-sm-5 single_left">
				...
				<br><p class="text-center"><strong>Adidas StanSmith Laced(Green)</strong></p>
			 </div>
			 <div class="col-sm-7 col_6">
					<h4><b>Description</b></h5>
					<p>Mens adidas Originals Stan Smith Sneakers in white.Iconic footwear with a fantastic discount.Originally created in 1973 for tennis star Stan Smith, the adidas Stan Smith shoes have dominated the test of time. Smooth full grain leather, perforated 3-Stripes and tonal rubber outsole are featured on this iconic low top sneaker. More clean and sleek than ever before, the adidas Stan Smith offers simplicity that can't be replicated.- Full grain leather upper- Synthetic lining- Perforated 3-Stripes- Smooth look- Tonal rubber outsole for gripLeather and synthetic upper, Textile and synthetic lining, synthetic sole 
<br><br>
<b>Features & details</b><br>
 <br>• Material Type: Synthetic
 <br>• Lifestyle: Casual
 <br>• Closure Type: Lace-Up</p>
 <br>
				<p class="movie_option"><strong>MRP: ₹ </strong><strike style="color:red">13,000</strike></p>
				<p class="movie_option"><strong>Our Price: ₹ </strong>3,500</p>
	    	...
	    	<h4 class="tag_head">Similar Products</h4>
	         <ul class="tags_images">
				...
				<li><a href="pic28.php"><img src="images/pic28.jpg" class="img-responsive" alt=""/></a></li>
